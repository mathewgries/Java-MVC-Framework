...
public class HomeController extends Controller {
	...
	private String instructions = 
			...
			"6.  To match columns, select the row from the table on the \"Matached Headers\" table, then select the headers from the Uncaptured and Captured Headers list on the right\n"+
